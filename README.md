...
```
 - terraform plan
  1. Verify the syntax of main.tfis correct
  2. Ensure the credentials file exists (contents will not be verified until terraform apply)
...
project = "infra-XXXXXXX"
public_key_path = "~/.ssh/id_rsa_test.pub"
disk_image = "reddit-base"
private_key = "~/.ssh/id_rsa_test"
zone = "europe-west1-b"
```
 - tasks with *
